...
"""Configuration file for the Brazil Data Cube Reproducible Research Management Server documentation.
...
import bdcrrm_server
import sphinx_rtd_theme


# -- Project information -----------------------------------------------------

project = 'BDCRRM_SERVER'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = bdcrrm_server.__version__
...
html_title = 'BDCRRM_SERVER'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'bdcrrm-server',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#BDCRRM_SERVER_EXAMPLE_URL = os.getenv('BDCRRM_SERVER_EXAMPLE_URL', None)
#'''
